        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-4 text-xs">
            <div className="flex items-center gap-1.5 text-slate-500">
              ...
              <span>Available: <strong>India, Dubai, Thailand</strong></span>
            </div>
        ...
        {activeTab === 'profile' && (
          <div className="max-w-2xl mx-auto bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-card space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
              ...
              <div className="p-4 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                <span className="text-slate-400 block text-[10px] uppercase font-bold">Advance Payment Method</span>
                <p className="font-bold text-slate-800 text-sm">bKash (01712-***678)</p>
                <p className="text-emerald-600 font-semibold">Instant 25% Advance Enabled</p>
              </div>
            </div>
            ...
            <div className="p-4 bg-brand-50 rounded-xl border border-brand-200 text-xs text-brand-900 flex items-center gap-3">
              ...
              <span>
                <strong>100% Sourcing Protection:</strong> Every product is purchased by our verified local agents in India, Dubai, or Thailand. If unavailable, 100% refund is processed in 24 hours.
              </span>
            </div>
          </div>
        )}
        ...
        <div className="flex items-center justify-around">
          ...
          >
            <div className="relative">
              ...
              <span className="w-2 h-2 rounded-full bg-brand-500 absolute -top-0.5 -right-0.5"></span>
            </div>
            <span>Pre-Order</span>
          </button>
          ...
          <button
            onClick={() => setActiveTab('profile')}
            className={`flex flex-col items-center gap-1 py-1 px-3 rounded-lg text-[11px] font-bold transition-all ${
              activeTab === 'profile' ? 'text-brand-600' : 'text-slate-400 hover:text-slate-600'
            }`}
          >
